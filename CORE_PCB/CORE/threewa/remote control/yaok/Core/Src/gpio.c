...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(CE_24L01_GPIO_Port, CE_24L01_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : KEY5_Pin KEY6_Pin KEY1_Pin */
  GPIO_InitStruct.Pin = KEY5_Pin|KEY6_Pin|KEY1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : KEY7_Pin KEY8_Pin KEY11_Pin */
  GPIO_InitStruct.Pin = KEY7_Pin|KEY8_Pin|KEY11_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : CSN_24L01_Pin */
